...
#ifndef CONFIGURATION__INIT_STICKLER_HPP_
#define CONFIGURATION__INIT_STICKLER_HPP_
...
class InitStickler : public BT::ActionNodeBase
{
public:
  explicit InitStickler(const std::string & xml_tag_name, const BT::NodeConfiguration & conf);
...
#endif  // CONFIGURATION__INIT_STICKLER_HPP_
