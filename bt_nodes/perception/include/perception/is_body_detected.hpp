...
#ifndef PERCEPTION__IS_BODY_DETECTED_HPP_
#define PERCEPTION__IS_BODY_DETECTED_HPP_
...
class IsBodyDetected : public BT::ConditionNode
{
public:
  explicit IsBodyDetected(const std::string & xml_tag_name, const BT::NodeConfiguration & conf);
  ...
  static BT::PortsList providedPorts()
  {
    return BT::PortsList(
      {BT::InputPort<int>("max_entities"),
       ...
       BT::OutputPort<std::vector<std::string>>("bodies")});
  }
...
#endif  // PERCEPTION__IS_BODY_DETECTED_HPP_
